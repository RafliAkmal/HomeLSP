          ...
          <div class="row d-flex">
            <div class="col">
              <ul class="justify-content-center">
                ...
                <h4 class="fw-bolder" style="color: #7D8F69;">Pengisian APL.02 Permohonan Sertifikasi Kompetensi</h1>
                <h5 class="mt-4 mb-2" style="color: #547153">Silakan Mengisi Data APL.02 Terlebih Dahulu</h5>
                <h6 class="mt-2 mb-2" style="color: #547153">Panduan Asesmen Mandiri</h6>

                <div class="card card-frame mt-2 mb-6">
                    <div class="card-body" style="background-color: #FFB9B9; color:black">
                      <p>• Baca setiap pertanyaan di kolom sebelah kiri</p>
                      <p>• Beri tanda ceklis (√) pada kotak jika Anda yakin dapat melakukan tugas yang dijelaskan</p>
                      <p>• Isi kolom di sebelah kanan dengan mendaftar bukti yang Anda miliki untuk menunjukkan bahwa Anda melakukan tugas-tugas ini</p>
                    </div>
                </div>
