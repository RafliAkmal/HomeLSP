          ...
          <div class="row d-flex">
            <div class="col">
              <ul class="justify-content-center">
                ...
                <h4 class="fw-bolder" style="color: #7D8F69;">Pengisian Persyaratan Dasar Pendaftaran (3/3)</h1>
                <h5 class="mt-4 mb-4" style="color: #547153">Silakan Mengisi Data Persyaratan Pendaftaran Terlebih Dahulu</h5>
                
                <label for="exampleFormControlSelect1">Foto/Hasil Pindai Kartu Tanda Penduduk (KTP)</label>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" placeholder="" aria-label="" aria-describedby="">
                  </div>

                <label for="exampleFormControlSelect1">Foto/Hasil Pindai Kartu Tanda Mahasiswa (KTM)</label>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" placeholder="" aria-label="" aria-describedby="">
                  </div>
                
                <label for="exampleFormControlSelect1">File/Hasil Pindai Daftar Hasil Studi (DHS) Terkini</label>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" placeholder="" aria-label="" aria-describedby="">
                  </div>
                
                <label for="exampleFormControlSelect1">Melaksanakan PKM (Praktik Keterampilan Mengajar) - Bagi Skema Pelaksanaan Program Tatap Muka atau PKL (Praktik Kerja Lapangan) - bagi Skema Lainnya                </label>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" placeholder="" aria-label="" aria-describedby="">
                  </div>

                <label for="exampleFormControlSelect1">Pas Foto Ukuran 3x4 (latar belakang merah)</label>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" placeholder="" aria-label="" aria-describedby="">
                  </div>
